; ModuleID = 'doubleBuffer.cpp'
source_filename = "doubleBuffer.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_doubleBuffer.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %3 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_doubleBuffer.cpp() #0 section ".text.startup" {
